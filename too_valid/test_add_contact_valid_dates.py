...
from too_valid.contact import Contact
...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        self.create_new_contact(wd, Contact(firstname = "test_fn",
                                            ...
                                            email_3 = "test_e3",
                                            homepage = "test_hp",
                                            birthday_date = "15-03-1982",
                                            anniversary_date = "24-03-2009",
    ...
    def input_contact_data(self, wd, contact_data):
        ...
        self._dropdown_element_input(wd, field_name="bday", value=str(contact_data.birthday_date.day))
        self._dropdown_element_input(wd, field_name="bmonth", value=contact_data.birthday_date.strftime('%B'))
        self._text_element_input(wd, field_name="byear", value=str(contact_data.birthday_date.year))
        self._dropdown_element_input(wd, field_name="aday", value=str(contact_data.anniversary_date.day))
        self._dropdown_element_input(wd, field_name="amonth", value=contact_data.anniversary_date.strftime('%B'))
        self._text_element_input(wd, field_name="ayear", value=str(contact_data.anniversary_date.year))
